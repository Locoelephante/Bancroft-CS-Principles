...
//  noStroke();
//  fill(0);
//  ellipse(275,237,25,40);
//  ellipse(280,300,30,116);
//  ellipse(150,260,50,30);
//  rect(250,215,20,50);
//  rect(215,280,50,50);
//  rect(240,250,50,50);
//  ellipse(220,260,130,65);
//  ellipse(285,330,22.5,75);
//  ellipse(250,310,80,50);
//  ellipse(250,325,80,45);
//  ellipse(245,335,90,45);
//  ellipse(240,345,100,45);
//  ellipse(235,355,110,45);
//  ellipse(230,365,120,45);
//  rect(150,375,150,30);
//  rect(160,365,130,10);
//  fill(255);
//  ellipse(140,290,80,40);
//  ellipse(132,232,85,40);
//  ellipse(285,210,45,40);
//  ellipse(247,210,30,40);
//}
